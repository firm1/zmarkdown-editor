...
public class JFontChooser extends JComponent {
  ...
  protected String _(String key) {
    String value = key;
    try {
        messageCatalog = ResourceBundle.getBundle(JFontChooser.class.getName() + "Messages", getLocale());
  ...
  protected JDialog createDialog(Component parent) {
    ...
    JDialog dialog = new JDialog(frame, _("Selectionnez votre police"), true);
